...
function createSandwich(...orderItems) {
    let summary = `Sandwich with ${orderItems.join(", ")}`;
    console.log(summary);
}

createSandwich("Kebab", "Egg", "Cheese");
createSandwich("Chicken Nuggets", "Egg", "chicken", "Mayo Garlic");
createSandwich("beep");